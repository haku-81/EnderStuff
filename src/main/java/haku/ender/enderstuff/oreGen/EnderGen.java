...
import haku.ender.enderstuff.EnderStuff;
...
public class EnderGen implements IWorldGenerator {
    @Override
    ...
    public void generateOverworld(World world, Random rand, int x, int z){
        generateOre(ModBlocks.enderOre, world, rand, x, z, 4, 6, 10, 1, 25, Blocks.stone);

    }

    public void generateEnd(World world, Random rand, int x, int z){
        generateOre(ModBlocks.enderOre, world, rand, x, z, 4, 6, 10, 1, 128, Blocks.end_stone);
    }
